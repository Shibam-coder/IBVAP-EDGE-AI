...
from ..ai.tripwire import TripwireManager, check_tripwire_crossing
from ..app.schemas import TripwireZone, TripwireEvent, DetectionItem


class TripwireService:
    """Service managing spatial tripwires and multi-camera boundary crossing evaluation."""
