...
from backend.app.ai.detection import YOLODetector, MockDetectionAdapter
from backend.app.models.schemas import DetectionItem
...
class DetectionService:
    ...
    def process_frame(
        ...
        """Run YOLO detection on an incoming frame."""
        if self.detector.is_real_yolo_loaded:
            ...
            # Fallback to deterministic dual-detection baseline if no scenario is given
